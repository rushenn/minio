...
let ObjectsList = ({objects, currentPath, selectPrefix, dataType, showDeleteConfirmation, shareObject, loadPath, checkObject, checkedObjectsArray, objectName}) => {
    const list = objects.map ((object, i) => {
        ...
        return (
            <div key={ i } className={ "objects__row " + folderClass + loadingClass + activeClass }>
